...
$(function(){function e(){$(".shift .amus-item").height("auto").equalHeights()}$({blurRadius:3}).animate({blurRadius:0},{duration:2400,easing:"swing",step:function(){$(".s-anim-item h3 span").css({"-webkit-filter":"blur("+this.blurRadius+"px)",filter:"blur("+this.blurRadius+"px)"})}});var a=$.animateNumber.numberStepFactories.separator(" ");$(".s-anim-item h3 span").each(function(){var e=$(this).data("count");$(this).animateNumber({number:e,easing:"easeInQuad","font-size":"1.8125em",numberStep:a},2400)}),$(".s-amusement h2").animated("slideInUp"),$(".s-amusement .s-descr").animated("slideInUp"),$(".age-button img").animated("bounceIn"),$(".s-holliday h2").animated("slideInUp"),$(".s-holliday .s-descr").animated("slideInUp"),$(".bd-wrap").animated("slideInLeft"),$(".corp-wrap").animated("slideInRight"),$(".amus-open-inner .pop-head").animated("slideInDown"),$(".bd-info-left img").animated("zoomInDown"),$(".corp-top-text img").animated("zoomInDown"),$(".bd-info-left p").animated("fadeInDown"),$(".corp-top-text p").animated("fadeInDown"),$(".right-block img").animated("fadeInRight"),$(".corp-top-img img").animated("fadeInLeft"),$(".s-restaurant .top").animated("slideInUp"),$(".res_bot_l").animated("slideInLeft"),$(".res_bot_r").animated("slideInRight"),$(".modal-box-content img").animated("slideInDown"),$(".foot-item h4").animated("slideInUp"),$(".foot-item .menu").animated("slideInLeft"),$(".foot-item p").animated("slideInRight"),$(".foot-item a").animated("slideInRight"),$(".foot-item .map").animated("slideInRight"),$(".social-wrap").animated("slideInUp"),$(".foot-center h4").animated("slideInUp"),$(".foot-center form").animated("slideInUp"),$(".owl-carousel").owlCarousel({nav:!0,items:1,dots:!0,loop:!0,autoHeight:!0,animateOut:"zoomOut",animateIn:"slideInUp",mouseDrag:!1,navText:['<i class="fa fa fa-caret-left"></i>','<i class="fa fa fa-caret-right"></i>'],responsive:{0:{items:1},600:{items:1},1e3:{items:1},1200:{items:1}}}),$(".w-time").click(function(e){e.preventDefault();var a=$(".active").not(this);a.find(".icon-minus").addClass("icon-plus").removeClass("icon-minus"),a.toggleClass("active").next(".w-time-open").slideToggle(500),$(this).toggleClass("active").next().slideToggle("fast"),$(this).children("i").toggleClass("icon-plus icon-minus")}),$(".card-button").click(function(e){e.preventDefault();var a=$(".active").not(this);a.find(".icon-minus").addClass("icon-plus").removeClass("icon-minus"),a.toggleClass("active").next(".card-list").slideToggle(500),$(this).toggleClass("active").next().slideToggle("fast"),$(this).children("i").toggleClass("icon-plus icon-minus")}),$(".s-amusement").parallax({imageSrc:"img/amus_bg.png"}),$(".s-holliday").parallax({imageSrc:"img/hol_bg.png"}),$(".menu ul a").mPageScroll2id({scrollSpeed:900}),$(".head-bottom a").mPageScroll2id({scrollSpeed:900}),$(".btn-wrap a").mPageScroll2id({scrollSpeed:900}),$(".card-wrap .top-b").mPageScroll2id({scrollSpeed:500}),$("#amusement").mixItUp(),$(window).resize(function(){e()}),$(".foot-item").height("auto").equalHeights(),$(".popup-with-move-anim").magnificPopup({type:"inline",fixedContentPos:!0,fixedBgPos:!0,overflowY:"scroll",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"mfp-zoom-in"}),$(".package-tab-wrap .tab_item").not(":first").hide(),$(".package-tab-wrap .tab").click(function(){$(".package-tab-wrap .tab").removeClass("active").eq($(this).index()).addClass("active"),$(".package-tab-wrap .tab_item").hide().eq($(this).index()).fadeIn()}).eq(0).addClass("active"),$(".img-svg").each(function(){var e=$(this),a=e.attr("id"),i=e.attr("class"),t=e.attr("src");$.get(t,function(t){var n=$(t).find("svg");void 0!==a&&(n=n.attr("id",a)),void 0!==i&&(n=n.attr("class",i+" replaced-svg")),n=n.removeAttr("xmlns:a"),!n.attr("viewBox")&&n.attr("height")&&n.attr("width")&&n.attr("viewBox","0 0 "+n.attr("height")+" "+n.attr("width")),e.replaceWith(n)},"xml")}),$(".form").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(".suсcess").addClass("visible"),setTimeout(function(){e.trigger("reset"),$(".success").removeClass("visible"),$.magnificPopup.close()},3e3)}),!1})});