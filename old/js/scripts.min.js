...
$(function(){var t="// Максим Краснов".split("");timeInterval=150,i=0,function o(){i<t.length&&($(".text-type").append(t[i]),i++,setTimeout(function(){o()},timeInterval))}(),$(".img-svg").each(function(){var n=$(this),e=n.attr("id"),i=n.attr("class"),o=n.attr("src");$.get(o,function(o){var t=$(o).find("svg");void 0!==e&&(t=t.attr("id",e)),void 0!==i&&(t=t.attr("class",i+" replaced-svg")),!(t=t.removeAttr("xmlns:a")).attr("viewBox")&&t.attr("height")&&t.attr("width")&&t.attr("viewBox","0 0 "+t.attr("height")+" "+t.attr("width")),n.replaceWith(t)},"xml")}),$(".copy-heading").animated("bounceIn"),$(".subtitle").animated("fadeInUp"),$(".header__top-line").animated("fadeInRight"),$(".header__bottom").animated("bounceIn"),$(".scroll-button").mPageScroll2id({scrollSpeed:700}),$(".button-case .btn-down").mPageScroll2id({scrollSpeed:700}),jQuery(document).ready(function(e){var i=e(".portfolio-wrap"),a=e(".portfolio-folding-panel"),r=e(".portfolio-main");function l(o,t){if(t){a.find(".portfolio-fold-content").load(o+" .portfolio-fold-content > *",function(o){setTimeout(function(){e("body").addClass("overflow-hidden"),a.addClass("is-open"),r.addClass("fold-is-open")},100)})}else{var n=d();a.removeClass("is-open"),r.removeClass("fold-is-open"),"mobile"==n||0<e(".no-csstransitions").length?e("body").removeClass("overflow-hidden"):r.find(".portfolio-item").eq(0).one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",function(){e("body").removeClass("overflow-hidden"),r.find(".portfolio-item").eq(0).off("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend")})}}function d(){return window.getComputedStyle(document.querySelector(".portfolio-main"),"::before").getPropertyValue("content").replace(/"/g,"").replace(/'/g,"")}i.on("click","a",function(o){var t,n;o.preventDefault(),t=e(this).attr("href"),n=d(),i.offset().top>e(window).scrollTop()&&"mobile"!=n?e("body,html").animate({scrollTop:i.offset().top},100,function(){l(t,!0)}):i.offset().top+i.height()<e(window).scrollTop()+e(window).height()&&"mobile"!=n?e("body,html").animate({scrollTop:i.offset().top+i.height()-e(window).height()},100,function(){l(t,!0)}):l(t,!0)}),a.on("click",".portfolio-fold-content-close",function(o){o.preventDefault(),l("",!1)}),i.on("click",function(o){e(o.target).is(".portfolio-wrap")&&0<e(".fold-is-open").length&&l("",!1)})})});