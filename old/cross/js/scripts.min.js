...
$(function(){$(".main-head").parallax({imageSrc:"img/main-top-bg.jpg"}),$("#portfolio_grid").mixItUp(),$(".s_portfolio li").click(function(){$(".s_portfolio li").removeClass("active"),$(this).addClass("active")}),$(".popup").magnificPopup({type:"image"}),$(".popup_content").magnificPopup({type:"inline",midClick:!0}),$(".toggle_mnu").click(function(){$(".sandwich").toggleClass("active")}),$(".top_mnu ul a").click(function(){$(".top_mnu").fadeOut(600),$(".sandwich").toggleClass("active"),$(".op").css("opacity","1")}).append("<span>"),$(".toggle_mnu").click(function(){$(".top_mnu").is(":visible")?($(".op").css("opacity","1"),$(".top_mnu").fadeOut(600),$(".top_mnu li a").removeClass("fadeInUp animated")):($(".op").css("opacity",".5"),$(".top_mnu").fadeIn(600),$(".top_mnu li a").addClass("fadeInUp animated"))}),$(".mouse-scroll").click(function(){$("html, body").animate({scrollTop:$("#cont-menu").offset().top},700)}),$(".min").click(function(){$("html, body").animate({scrollTop:$("#cont-menu-min").offset().top},700)}),$(".proj-end").click(function(){$("html, body").animate({scrollTop:$("#proj-top").offset().top},700)}),$(".proj-end-spec").click(function(){$("html, body").animate({scrollTop:$("#proj-top-spec").offset().top},700)}),$("h1, h2, h3, h4, p").addClass("op"),$l=$(".left"),$r=$(".right"),$l2=$(".left2"),$r2=$(".right2"),$l.mouseenter(function(){$(".cont-menu").addClass("left-is-hovered")}).mouseleave(function(){$(".cont-menu").removeClass("left-is-hovered")}),$l2.mouseenter(function(){$(".cont-menu").addClass("left2-is-hovered")}).mouseleave(function(){$(".cont-menu").removeClass("left2-is-hovered")}),$r2.mouseenter(function(){$(".cont-menu").addClass("right2-is-hovered")}).mouseleave(function(){$(".cont-menu").removeClass("right2-is-hovered")}),$r.mouseenter(function(){$(".cont-menu").addClass("right-is-hovered")}).mouseleave(function(){$(".cont-menu").removeClass("right-is-hovered")}),$(".owl-carousel").owlCarousel({nav:!0,loop:!0,smartSpeed:700,autoplay:!0,autoplayTimeout:3e3,autoplayHoverPause:!0,navText:['<i class="fa fa fa-chevron-left"></i>','<i class="fa fa fa-chevron-right"></i>'],responsive:{0:{items:1},600:{items:2},720:{items:2},1e3:{items:3},1200:{items:4}}}),$(".portfolio_item").each(function(e){$(this).find("button").attr("href","#project_"+e),$(this).find(".podrt_descr").attr("id","project_"+e)}),$(".tab-item").not(":first").hide(),$(".wrapper .tab").click(function(){$(".wrapper .tab").removeClass("active").eq($(this).index()).addClass("active"),$(".tab-item").hide().eq($(this).index()).fadeIn()}).eq(0).addClass("active"),$(".resume").click(function(e){e.preventDefault();var t=$(".active").not(this);t.find(".icon-minus").addClass("icon-plus").removeClass("icon-minus"),t.toggleClass("active").next(".resumeopen").slideToggle(500),$(this).toggleClass("active").next().slideToggle("fast"),$(this).children("i").toggleClass("icon-plus icon-minus")}),$(".project").click(function(e){e.preventDefault();var t=$(".active").not(this);t.find(".icon-minus").addClass("icon-plus").removeClass("icon-minus"),t.toggleClass("active").next(".projectopen").slideToggle(500),$(this).toggleClass("active").next().slideToggle("fast"),$(this).children("i").toggleClass("icon-plus icon-minus")}),$(".form-msg").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(".suсcess").addClass("visible"),setTimeout(function(){e.trigger("reset"),$(".success").removeClass("visible"),$.magnificPopup.close()},3e3)}),!1})});